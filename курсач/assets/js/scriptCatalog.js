...
window.onload = function () {
   ...
   const clcoseButton = document.querySelectorAll('.card__info-close');

   clcoseButton[0].onclick = function () {
      ...
      cardInfo[0].classList.add("info-not-active");
      cardInfo[1].classList.add("info-not-active");
      cardInfo[2].classList.add("info-not-active");
      cardInfo[3].classList.add("info-not-active");
   }

   clcoseButton[1].onclick = function () {
      container[0].classList.remove("cards-not-active");
      container[1].classList.remove("cards-not-active");
      container[2].classList.remove("cards-not-active");
      container[3].classList.remove("cards-not-active");
   ...
   clcoseButton[2].onclick = function () {
      container[0].classList.remove("cards-not-active");
      container[1].classList.remove("cards-not-active");
      container[2].classList.remove("cards-not-active");
      container[3].classList.remove("cards-not-active");
   ...
   clcoseButton[3].onclick = function () {
      container[0].classList.remove("cards-not-active");
      container[1].classList.remove("cards-not-active");
      container[2].classList.remove("cards-not-active");
      container[3].classList.remove("cards-not-active");
   ...
   card0.onclick = function () {
      ...
      cardInfo[0].classList.remove("info-not-active");
   ...
   card7.onclick = function () {
      ...
      cardInfo[1].classList.remove("info-not-active");
   ...
   card11.onclick = function () {
      ...
      cardInfo[2].classList.remove("info-not-active");
   ...
   card15.onclick = function () {
      ...
      cardInfo[3].classList.remove("info-not-active");
